		...
		extend: {
			colors: {
				...
				agriculture: {
					...
					'green-light': 'hsl(var(--agriculture-green-light))'
				},
				irrigation: {
					blue: 'hsl(var(--irrigation-blue))',
					'blue-light': 'hsl(var(--irrigation-blue-light))'
				},
				warning: {
			...
			backgroundImage: {
				...
				'gradient-irrigation': 'var(--gradient-irrigation)',
